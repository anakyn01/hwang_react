set -gx CONDA_EXE (cygpath "D:/hwang_react/6_python/mini\Scripts\conda.exe");
set -gx _CONDA_EXE (cygpath "D:/hwang_react/6_python/mini\Scripts\conda.exe");
set -e _CE_M || true;
set -e _CE_CONDA || true;
set -gx CONDA_PYTHON_EXE (cygpath "D:/hwang_react/6_python/mini\python.exe");
set -gx _CONDA_ROOT (cygpath "D:/hwang_react/6_python/mini");
