...
화면을 만들기 위해 StatefulWidget을 사용합니다.
...
{'icon': '☕', 'label': '카페'},
    ...
    Widget build(BuildContext context){
        return Scaffold(
            ...
            body: SafeArea(// 핸드폰의 노치(카메라 파인 부분)나 하단 바에 UI가 가려지지 않게 보호해줍니다.
child:Column(// 위에서 아래로 위젯(화면 조각)들을 차곡차곡 쌓습니다
children:[
_buildTopBar(),// 맨 위에 뒤로가기 버튼과 분홍색 진행률 바를 그립니다.
Expanded(//남은 화면 공간을 꽉 채우라는 뜻입니다.
...
children:[
    ...
    _buildInterestsSection(), const SizedBox(height:40),
...
const SizedBox(width:16),
Text('3 / 5', style:TextStyle(color:subTextColor, fontSize:14,
FontWeight.bold)),
],
),
);
...
Widget _buildHeader(){
    return Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children:[
 Text('나를 소개해요',style:TextStyle(color:textColor, 
 fontSize:26, fontWeight:FontWeight.w800)),
 const SizedBox(height:8),
 Text('프로필 사진과 기본 정보를 입력해주세요',
